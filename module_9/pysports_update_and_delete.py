...
def show_players(cursor, title):
    # method to execute an inner join on the player and team table, iterate over the dataset and output the results
...
try:
    # try/catch block for handling potential MySQL dv errors 

    db = mysql.connector.connect(**config) # connect to pysports db
